...
const Page1 = ({navigation}) => ( 
    <View style={{ flex:1 }}>
        ...
        <Text style={{ height: 50, color: "black", marginTop:50, textAlign:"center", fontSize:20, }}>Selecione a opção desejada</Text> 
            <View style={{ 
                  marginRight:40, marginLeft:40,marginBottom:30,marginTop:20,
