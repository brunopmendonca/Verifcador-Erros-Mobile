...
import Tcom from '../arquivos/tcom'
...
const TCOM1 = () => {
  ...
  function Hand(e) {
    ...
    try {
      setResultado1(`Decimal ${filtrar[0].TCOM}`)
...
${filtrar[0].__EMPTY_2}`)
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={{ height: 50, color: "black", textAlign: "center", fontSize: 25, }}>(TCOM)</Text>
